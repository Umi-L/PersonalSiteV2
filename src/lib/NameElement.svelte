...
<div class="name" role="button" on:click={onClick} on:keypress={onKeyPress} tabindex={1} on:mouseenter={mouseenter} on:mouseleave={mouseleave}>
    Julian<div class="underline"></div>
</div>
