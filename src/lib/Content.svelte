<script lang="ts">
  ...
  const whisperingEchosDisc = "";
  const sparkForgeDisc =
    " It is then designed to slowly teach them how to program in a more traditional way by showing the code generated by their flowcharts.";
</script>
